...
export const SERVICE_CATALOG: ServicePreset[] = [
  ...
  { id: 'claude-pro', name: 'Claude Pro', icon: '🧠', gradient: 'linear-gradient(135deg, #ce7f4a, #8b502c)', price: 5.99, original: 22.00, tagline: 'Claude Opus 4.7 selon offre', maxSlots: 4, features: ['Claude Opus 4.7', 'Usage renforcé selon offre', 'Projets'], category: 'ai' },
  { id: 'perplexity-pro', name: 'Perplexity Pro', icon: '🔍', gradient: 'linear-gradient(135deg, #20808d, #0e3d44)', price: 4.99, original: 20.00, tagline: 'Recherche IA avancée', maxSlots: 4, features: ['Pro Search selon offre', 'Modèles avancés', 'Fichiers'], category: 'ai' },
  { id: 'midjourney-pro', name: 'Midjourney Pro', icon: '🎨', gradient: 'linear-gradient(135deg, #1a1a2e, #16213e)', price: 14.99, original: 60.00, tagline: 'Génération d\'images IA avancée', maxSlots: 2, features: ['Mode stealth selon offre', 'Génération rapide selon file d’attente', 'Usage commercial selon conditions'], category: 'ai' },
  ...
  { id: 'google-one-2to', name: 'Google One 2 To', icon: '☁️', gradient: 'linear-gradient(135deg, #4285f4, #34a853)', price: 1.99, original: 9.99, tagline: '2 To de stockage Google', maxSlots: 5, features: ['2 To', 'Photos selon quota', '5 invités famille'], category: 'storage' },
  ...
  { id: 'notion-plus', name: 'Notion Plus', icon: '📝', gradient: 'linear-gradient(135deg, #2f3437, #6b6b6b)', price: 3.99, original: 11.50, tagline: 'Workspace avancé', maxSlots: 1, features: ['Pages selon conditions Notion', 'Historique 30j', 'Notion AI add-on'], category: 'productivity' },
  ...
  { id: 'adobe-creative-cloud', name: 'Adobe Creative Cloud', icon: '🎨', gradient: 'linear-gradient(135deg, #fa0f00, #b00b00)', price: 14.99, original: 71.99, tagline: 'Apps Adobe selon offre', maxSlots: 1, features: ['Photoshop, Premiere, Illustrator…', '100 Go cloud', 'Firefly IA'], category: 'productivity' },
  ...
  { id: 'figma-pro', name: 'Figma Professional', icon: '🎯', gradient: 'linear-gradient(135deg, #f24e1e, #a259ff)', price: 5.99, original: 15.00, tagline: 'Design UI/UX pro', maxSlots: 1, features: ['Projets selon offre', 'Historique selon offre', 'Composants partagés'], category: 'productivity' },
  ...
  { id: 'expressvpn', name: 'ExpressVPN', icon: '🔐', gradient: 'linear-gradient(135deg, #da3940, #8d181c)', price: 2.49, original: 12.95, tagline: 'VPN performant selon offre', maxSlots: 5, features: ['5 appareils', 'TrustedServer', 'Lightway protocol'], category: 'vpn' },
  { id: 'surfshark', name: 'Surfshark VPN One', icon: '🦈', gradient: 'linear-gradient(135deg, #1ebfbf, #25a39e)', price: 1.49, original: 12.99, tagline: 'Appareils selon offre', maxSlots: 10, features: ['Connexions selon conditions', 'Antivirus', 'Alert + Search'], category: 'vpn' },
  ...
  { id: 'ubisoft-plus', name: 'Ubisoft+ Premium', icon: '🎯', gradient: 'linear-gradient(135deg, #00aeff, #006bb3)', price: 4.99, original: 17.99, tagline: 'Catalogue Ubisoft selon offre', maxSlots: 2, features: ['Jeux Ubisoft selon catalogue', 'Nouveautés selon offre', 'DLC selon offre'], category: 'gaming' },
  { id: 'ea-play-pro', name: 'EA Play Pro', icon: '🏈', gradient: 'linear-gradient(135deg, #ff4747, #b32525)', price: 3.99, original: 16.99, tagline: 'Catalogue EA selon offre', maxSlots: 2, features: ['Sélection de jeux EA', 'Editions selon offre', 'DLC selon offre'], category: 'gaming' },

  // ─── Apprentissage & Bien-être ───────────────────────────────────
  { id: 'duolingo-super', name: 'Duolingo Super Famille', icon: '🦉', gradient: 'linear-gradient(135deg, #58cc02, #2e6a01)', price: 1.99, original: 10.42, tagline: 'Apprentissage langues 6 personnes', maxSlots: 6, features: ['Sans pub', '6 comptes', 'Exercices selon offre'], category: 'learning' },
  { id: 'babbel', name: 'Babbel', icon: '🗣️', gradient: 'linear-gradient(135deg, #ff9514, #cc7610)', price: 3.99, original: 12.49, tagline: '14 langues à apprendre', maxSlots: 1, features: ['14 langues', 'Babbel Live', 'Hors-ligne'], category: 'learning' },
  ...
  { id: 'kindle-unlimited', name: 'Kindle Unlimited', icon: '📚', gradient: 'linear-gradient(135deg, #00a8e1, #006b8e)', price: 3.99, original: 9.99, tagline: 'Lecture selon catalogue Kindle', maxSlots: 1, features: ['Catalogue Kindle', 'Magazines', 'Audible Narration'], category: 'press' },
  { id: 'storytel', name: 'Storytel', icon: '🎙️', gradient: 'linear-gradient(135deg, #ec5f4b, #a13524)', price: 5.99, original: 14.99, tagline: 'Livres audio + ebooks', maxSlots: 1, features: ['Écoute selon catalogue', 'Mode famille'], category: 'press' },
  ...
  { id: 'le-figaro-premium', name: 'Le Figaro Premium', icon: '📰', gradient: 'linear-gradient(135deg, #0a4a8f, #052a52)', price: 4.99, original: 12.90, tagline: 'Articles du Figaro selon offre', maxSlots: 1, features: ['Articles selon offre', 'Magazine', 'Newsletter'], category: 'press' },
  ...
  { id: 'lequipe-digital', name: "L'Équipe Digital", icon: '⚽', gradient: 'linear-gradient(135deg, #ffd400, #b39400)', price: 2.99, original: 9.99, tagline: 'Sports + journal numérique', maxSlots: 1, features: ['Articles selon offre', 'Live scores', 'Journal numérique'], category: 'press' },
];
