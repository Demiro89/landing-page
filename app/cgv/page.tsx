    ...
    >
      ...
      <ul>
        ...
        <li>
          ...
          il renonce à son droit de rétractation (voir article 7).
        </li>
      </ul>
      <p>
      ...
      <p>
        ...
        confirmation du paiement, généralement de manière immédiate et au plus tard sous quelques heures.
      ...
      <h2 id="remboursements">8. Remboursements & garantie</h2>
      <p>
      ...
      <h2 id="reclamations">9. Réclamations</h2>
      <p>
      ...
      <h2 id="mediation">10. Médiation de la consommation</h2>
      <p>
      ...
      <h2 id="non-affiliation">11. Non-affiliation</h2>
      <div className="legal-callout">
        <p>{NON_AFFILIATION_LONG}</p>
      </div>

      <h2 id="droit">12. Loi applicable et juridiction</h2>
      <p>
